...
import com.tencent.tws.phoneside.walletv2.common.Utils.WalletCity;
...
import com.tencent.tws.phoneside.walletv2.ui.widget.BottomBar;
import com.tencent.tws.phoneside.walletv2.ui.widget.BottomBar.OnBottomBarClickListener;
import com.tencent.tws.phoneside.walletv2.ui.widget.PayValueSelect;
import com.tencent.tws.phoneside.walletv2.ui.widget.PayValueSelect.OnSelectChangeListener;
...
public class ActivateCardActivity extends TwsActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			mCard = CardManager.getInstance().getCard(instanceId);//NFCHelper.getCard(type, instanceId);
			...
			public boolean onSingleButtonWithDecClick() {
                ...
                if (!PayManager.isPayChannelSupport(payType)) {
                    Toast.makeText(GlobalObj.g_appContext,
                            (payType == PAY_CHANNEL_QQ) ? R.string.login_download_qq : R.string.login_download_mm,
                            Toast.LENGTH_LONG).show();
                    return false;
                }
